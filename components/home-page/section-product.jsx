    ...
    <section className="section-product-home-page-v3">
      <div className="container-1220">
        <Row className="row-line-center">
          ...
          <h2 className="title-line-center">{t('homePage.products.mainTitle')}</h2>
        ...
        {arrSmartTouch.map((smart) => {
          return (
            <Row
              key={smart.id}
              className={`${
                smart.id % 2 === 0 ? 'card-product' : 'card-product flex-row-reverse'
              } `}
            >
              <Col lg={7} md={6}>
                  ...
                  {smart.listItem.map((item) => (
                    <li key={item.id} className="card-product-item">
                      <div className="d-flex align-items-center">
                        ...
                        <h4 className="card-product-item-title">{item.title}</h4>
                      </div>
                      <div>
