  ...
  content: [
    {
      ...
      deviceList: [
        ...
        {
          id: "1",
          deviceName: "Bộ điều khiển trung tâm Gateway",
          inBasic: true,
          inAdvanced: true,
        },
        {
        ...
        {
          id: "3",
          deviceName: "Bộ Điều Khiển Hồng Ngoại",
          inBasic: true,
          inAdvanced: true,
        },
        {
          id: "4",
          deviceName: "Bộ điều nhiệt",
          inBasic: true,
          inAdvanced: true,
        },
      ],
    },
    {
      ...
      deviceList: [
        ...
        {
          id: "2",
          deviceName: "Công tắc cơ (Vuông - Trắng - 3 nút - 1 dây)",
          inBasic: true,
          inAdvanced: true,
        },
        {
          id: "3",
          deviceName:
            "Công tắc cảm ứng (Vuông - Trắng - Viền mạ vàng - 1,2,3,4,6 nút - 2 dây)",
          inBasic: true,
          inAdvanced: true,
        },
        {
          id: "4",
          deviceName: "Led downlight (7/9/12W)",
          inBasic: false,
          inAdvanced: true,
        },
        {
          id: "5",
          deviceName: "Led Driver 10 kênh",
          inBasic: false,
          inAdvanced: true,
        },
        {
          id: "6",
          deviceName: "Cảm biến ánh sáng",
          inBasic: false,
          inAdvanced: true,
        },
        {
          id: "7",
          deviceName: "Cảm biến chuyển động",
          inBasic: false,
          inAdvanced: true,
        },
        {
          id: "8",
          deviceName: "Công tắc cơ pin",
          inBasic: false,
          inAdvanced: true,
        },
        {
          id: "9",
          deviceName: "Cảm biến cửa",
          inBasic: false,
          inAdvanced: true,
        },
      ],
