    ...
    <div className="news-page-body container-wrap">
        ...
        <div className="news-page-content">
          ...
          <div className="news-page-description">
            <ul>
              <li> Thiết Kế Mạch</li>
              <li> Lập Trình App</li>
              <li> Lắp Đặt & Vận Hành Thương Mại</li>
            </ul>
          </div>
        </div>
      ...
      <div className="news-page-body-in-right">
        <span className="news-page-body-in-right-title fs-32 fw-bold">News</span>
        {
          posts.map((post) => {
            return (
              <CardHorizonal slug={post.frontmatter.slug} isVideo={post.isVideo}
                imgUrl={post.frontmatter.featuredImage.childImageSharp.fluid.src} data={data.slice(0, 5)} />
            )
          })
        }
      </div>
