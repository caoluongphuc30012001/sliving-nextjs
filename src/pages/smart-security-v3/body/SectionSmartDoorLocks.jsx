          ...
          <Row className="gx-md-4 gy-4 px-0  ">
            ...
            <Col md={6} className="col-main-smart-door">
              ...
              <p className="sub-title-smart-door">
                Hỗ trợ các chế độ truy cập như: thẻ từ, mã số, vân tay, chìa
                khoá, chuông cửa có hình, điều khiển từ xa...
              </p>
              <p className="title-smart-door-2">
                <Image src={iconV} />
              ...
              <p className="sub-title-smart-door">
                Bảo vệ an toàn tuyệt đối cho căn hộ với các tính năng bảo mật
                như: báo động âm thanh khi khóa bị tác động một lực mạnh bên
                ngoài, tự động vô hiệu hóa khi nhập sai mật khẩu nhiều lần liên
                tiếp,...
              </p>
              <p className="title-smart-door-2">
                <Image src={iconV} />
              ...
              <p className="sub-title-smart-door">
                Tăng cường kết nối cho phép bạn khóa và mở cửa từ xa. Tự động
                gửi tin nhắn, báo cáo lịch sử ra vào. Cung cấp giải pháp ưu việt
                cho chủ nhà trọ, Homestay để bảo vệ tài sản và quản lý dễ dàng
                hơn.
              </p>
            </Col>
          </Row>
