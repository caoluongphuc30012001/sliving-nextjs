  ...
  return (
    <section className="bg-smart-door-locks" id="smart-elevator">
      <Container className="max-width-1180 padding-left-right-smart-door">
        ...
        <h2 className="title-smart-secuirity">Hệ Thống Thang Máy Thông Minh</h2>
        <div>
        ...
        <Row className="gx-md-4 gy-4 px-0 mt-3">
          ...
          <Col md={6} className="col-main-smart-door">
            ...
            <p className="sub-title-smart-door">
              ...
              chuyển đến các tầng cụ thể. Đem đến sự kiểm soát an ninh tuyệt đối
              với các trường hợp người lạ vào tòa nhà.
            </p>
            <p className="title-smart-door-2">
              <Image src={iconV} />
