    ...
    <div className="hp-banner">
      <div className="container-wrap">
        <div className="hp-banner-wrap">
          ...
          <div className="hp-banner-btn"> <ButtonMore backgroundColor={'#F47403'} color={'#f9f9f9'} borderReadius={'16px'} padding={'4px 7px 4px 13px'} fontWeight={'700'} url={'/intro-content-page/'} /></div>
        </div>
      </div>
    </div>
  );
