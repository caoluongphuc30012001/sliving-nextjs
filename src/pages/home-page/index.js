        ...
        <div className="home-page-main">
          ...
          >
            <span>
              ...
              <ul>
                <li>
                  Xây dựng thiết kế giao diện các ứng dụng di động (Mobile App),
                  trang mạng (website) cho việc giám sát, điều khiển và giới
                  thiệu sản phẩm.
                </li>
                <li>Thiết kế phần cứng (Hardware) của Sản phẩm</li>
                <li>Sản xuất thiết bị công nghệ thông minh</li>
                <li>
                  Xây dựng các chương trình máy tính như Firmware, Cloud Server
                </li>
                <li>AI ( Trí tuệ nhân tạo )</li>
              </ul>
              Trong những năm qua, Sliving luôn không ngừng phát triển và cho ra
              đời các giải pháp công nghệ tiên tiến giúp mỗi người dùng có thể
              trải nghiệm một cuộc sống tiện nghi, thoải mái và tiện lợi nhất...
            </span>
          </Sectionorizontal>
          <SectionVideo />
          <SectionProject />
